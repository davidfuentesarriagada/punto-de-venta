<main>
    <div class="container-fluid">
        ...
        <form method="POST" action="<?php echo site_url('productos/nuevo'); ?>" enctype="multipart/form-data" autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-4">
                        ...
                        <input class="form-control form-control-sm" id="codigo" name="codigo" type="text" onblur="buscarProducto(this, this.value)" value="<?php echo set_value('codigo'); ?>" autofocus required />
                    ...
                    <div class="col-12 col-sm-8">
                        ...
                        <input class="form-control form-control-sm" id="nombre" name="nombre" type="text" value="<?php echo set_value('nombre'); ?>" required />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <input class="form-control form-control-sm" id="precio_venta" name="precio_venta" type="text" onkeypress="return validateDecimal(this.value);" value="0.00" required />
                    </div>

                    <div class="col-12 col-sm-6">
                        <label>Precio costo</label>
                        <input class="form-control form-control-sm" id="precio_compra" name="precio_compra" type="text" onkeypress="return validateDecimal(this.value);" value="0.00" />
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control form-control-sm" id="existencias" name="existencias" type="text" value="0" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control form-control-sm" id="stock_minimo" name="stock_minimo" type="text" value="0" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        $('#inventariable').change(function() {
            if (this.checked) {
                ...
                $("#existencias").prop('readonly', false);
            } else {
                $("#stock_minimo").prop('readonly', true);
                $("#existencias").prop('readonly', true);
            }
            $("#stock_minimo").val(0);
            $("#existencias").val(0);
        });
                ...
                success: function(resultado) {
                    if (resultado == 0) {
                        ...
                        if (resultado.existe) {
                            ...
                            $(tagCodigo).prop("class", "form-control form-control-sm is-invalid");
                            $(tagCodigo).val('');
                            $(tagCodigo).focus();
                        } else {
                            $(tagCodigo).removeProp("aria-describedby");
                            $(tagCodigo).prop("class", "form-control form-control-sm");
                        }
                    }
                }
            });
