<main>
    <div class="container-fluid">
        <h4 class="mt-4">Agregar unidad</h4>
        ...
        <form method="POST" action="<?php echo site_url('unidades/nuevo'); ?>" autocomplete="off">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <label><i class="campo-obligatorio">*</i> Nombre corto</label>
                        <input class="form-control" id="nombre_corto" name="nombre_corto" type="text" value="<?php echo esc(set_value('nombre_corto')); ?>" required />
                    </div>
                </div>
            </div>
